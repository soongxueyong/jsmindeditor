...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('jsmind')) :
    typeof define === 'function' && define.amd ? define(['exports', 'jsmind'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.jsMindDraggableNode = {}, global.jsMind));
})(this, (function (exports, jsMind) { 'use strict';

    function _interopDefaultLegacy (e) { return e && typeof e === 'object' && 'default' in e ? e : { 'default': e }; }

    var jsMind__default = /*#__PURE__*/_interopDefaultLegacy(jsMind);

    if (!jsMind__default["default"]) {
        throw new Error('jsMind is not defined');
    }
    const $ = jsMind__default["default"].$;
    ...
    class DraggableNode {
        constructor(jm, options) {
            var opts = {};
            jsMind__default["default"].util.json.merge(opts, DEFAULT_OPTIONS);
            jsMind__default["default"].util.json.merge(opts, options);
            this.version = '0.4.0';
            this.jm = jm;
            this.options = opts;
            this.e_canvas = null;
        ...
        lookup_target_node() {
            ...
            let target_direction =
                this.shadow_p_x + this.shadow_w / 2 >= this.get_root_x()
                    ? jsMind__default["default"].direction.right
                    : jsMind__default["default"].direction.left;
            ...
            if (!!target_node) {
                ...
                let invalid = jsMind__default["default"].node.inherited(this.active_node, target_node);
        ...
        shadow_on_target_side(node, dir) {
            return (
                (dir == jsMind__default["default"].direction.right && this.shadow_to_right_of_node(node) > 0) ||
                (dir == jsMind__default["default"].direction.left && this.shadow_to_left_of_node(node) > 0)
            );
        }
        ...
        shadow_to_node(node, dir) {
            let distance_x =
                dir === jsMind__default["default"].direction.right
        ...
        move_node(src_node, target_node, target_direct) {
            ...
            if (!!target_node && !!src_node && !jsMind__default["default"].node.inherited(src_node, target_node)) {
        ...
        jm_event_handle(type, data) {
            if (type === jsMind__default["default"].event_type.resize) {
                this.resize();
            }
        }
    }
    const draggable_plugin = new jsMind__default["default"].plugin('draggable_node', function (jm, options) {
    ...
    jsMind__default["default"].register_plugin(draggable_plugin);

    exports.DraggableNode = DraggableNode;
    exports["default"] = DraggableNode;
    exports.draggable_plugin = draggable_plugin;
